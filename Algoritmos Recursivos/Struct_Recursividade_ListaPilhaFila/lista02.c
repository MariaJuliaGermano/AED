...
int main() {
    ...
    do {
        ...
        printf("5. Contar elementos (iterativo)\n");
        printf("6. Contar elementos (recursivo)\n");
        printf("7. Sair\n");
        ...
        switch(opcao) {
            ...
            case 5:
                printf("Número de elementos na lista (iterativo): %d\n", 
                       contar_elementos(lista));
                break;
                
            case 6:
                printf("Número de elementos na lista (recursivo): %d\n", 
                       contar_elementos_recursivo(lista));
                break;
